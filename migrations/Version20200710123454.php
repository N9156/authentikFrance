 ...
 */
final class Version20200710123454 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(255) NOT NULL, userlastname VARCHAR(255) NOT NULL, age VARCHAR(5) NOT NULL, sex VARCHAR(255) NOT NULL, adress VARCHAR(255) NOT NULL, town VARCHAR(255) NOT NULL, postcode VARCHAR(10) NOT NULL, phone VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, nationality VARCHAR(255) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
