 ...
 */
final class Version20200715150506 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE site_touristique (id INT AUTO_INCREMENT NOT NULL, category_id INT NOT NULL, user_id INT NOT NULL, title VARCHAR(255) NOT NULL, content LONGTEXT NOT NULL, image VARCHAR(255) NOT NULL, adress VARCHAR(255) NOT NULL, phone VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, contact_professionnel VARCHAR(255) NOT NULL, url VARCHAR(255) NOT NULL, publication VARCHAR(255) NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_59B8727B12469DE2 (category_id), INDEX IDX_59B8727BA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, username VARCHAR(255) NOT NULL, userlastname VARCHAR(255) NOT NULL, age VARCHAR(5) NOT NULL, sex VARCHAR(255) NOT NULL, adress VARCHAR(255) NOT NULL, town VARCHAR(255) NOT NULL, postcode VARCHAR(10) NOT NULL, phone VARCHAR(255) NOT NULL, mail VARCHAR(255) NOT NULL, nationality VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
